...
#BSUB -W 2:00
#BSUB -q batch
#BSUB -o logs/gpt_neox-modified_roberta_base-%J.out
#BSUB -e logs/gpt_neox-modified_roberta_base-%J.err
#BSUB -J gpt_neox-modified_roberta_base
...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py \
	         --conf_dir $TRAIN_PATH/configs_jerry modified_roberta/modified_roberta_base.yml datasets/train/rp.yml datasets/val/pile_rp.yml setup_modified_roberta.yml

...
# Run
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py --conf_dir $TRAIN_PATH/configs_mlm setup/setup_modified_roberta_base_resume.yml modified_roberta/modified_roberta_base.yml datasets_ben/val/pile_slimp.yml datasets_ben/train/slim_pajama_606B.yml load_ben/modified_roberta_base_mlm.yml 
...
#BSUB -W 1:00
#BSUB -q debug
#BSUB -o logs/gpt_neox-roberta_large-debug-%J.out
#BSUB -e logs/gpt_neox-roberta_large-debug-%J.err
#BSUB -J gpt_neox-roberta_large-debug
...
python $TRAIN_PATH/deepy.py $TRAIN_PATH/train.py \
	         --conf_dir $TRAIN_PATH/configs_jerry roberta/roberta_large.yml datasets/train/rp.yml datasets/val/pile_rp.yml roberta_setup.yml

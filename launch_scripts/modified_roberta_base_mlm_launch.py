...
tmp = "\"/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/checkpoints/modified_roberta_base_mlm/\"".format(args.job_id)

file_contents = "{\n\"load\":" + tmp + "\n}"

with open("/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/configs_mlm/load_ben/modified_roberta_base_mlm.yml",'w') as f:
...
bkill {}
python /gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/launch_scripts/modified_roberta_base_mlm_launch.py --job-id $LSB_JOBID &
PYTHON_PID=$!
...
job_script_path = "/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/jobs/modified_roberta_base_mlm-recurring.sh"

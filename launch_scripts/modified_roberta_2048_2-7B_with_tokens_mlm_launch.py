...
tmp = "\"/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/checkpoints/modified_roberta_2048_2-7B_with_tokens_mlm/\"".format(args.job_id)

file_contents = "{\n\"load\":" + tmp + "\n}"

with open("/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/configs_mlm/load_ben/modified_roberta_2048_2-7B_with_tokens_mlm.yml",'w') as f:
...
#BSUB -e /gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/logs/modified_roberta_2048_2-7B_with_tokens_mlm-%J.err
#BSUB -J modified_roberta_2048_2-7B_with_tokens_mlm
...
bkill {}
python /gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/launch_scripts/modified_roberta_2048_2-7B_with_tokens_mlm_launch.py --job-id $LSB_JOBID &
PYTHON_PID=$!
...
setup/setup_modified_roberta_2048_2-7B_with_tokens_resume.yml \
modified_roberta_2048/modified_roberta_2048_2-7B_with_tokens.yml \
datasets_ben/val/pile_slimp.yml \
datasets_ben/train/slim_pajama_606B.yml \
load_ben/modified_roberta_2048_2-7B_with_tokens_mlm.yml
""".format(args.job_id, args.job_id)

job_script_path = "/gpfs/alpine/csc499/scratch/jerry.huang/gpt-neox/jobs/modified_roberta_2048_2-7B_with_tokens_mlm-recurring.sh"
